...
ExecuterSetting::ExecuterSetting(vector<int>& p_generationToSave, vector<int>& p_generationToOpt, W* p_w_func, P* p_p_func){
    w_func = p_w_func;
    p_func = p_p_func;
...
W* ExecuterSetting::get_w_func(){
    return w_func;
}

P* ExecuterSetting::get_p_func(){
    return p_func;
}
