...
class StartFunction{
    ...
    public:
        ...
        Generation* calc_startingGeneration(const double* p_sampleArea, const double& p_numberOfPoints);
        ...
        // @param const double& p_numberOfPoints - number of points to be generated according to the start function
};
